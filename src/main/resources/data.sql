-- === Insert Users First ===
INSERT INTO user_entity (id, username, password, email, role, full_name, created_at) VALUES (1, 'admin', '$2a$10$ZsmpxUN3qGjWI2oDEhvrHOnBaF9kM4QK1WeoUxXuWVwjYKyHoPSMi', 'admin@amdox.com', 'ADMIN', 'System Admin', CURRENT_TIMESTAMP());
INSERT INTO user_entity (id, username, password, email, role, full_name, created_at) VALUES (2, 'john', '$2a$10$ZsmpxUN3qGjWI2oDEhvrHOnBaF9kM4QK1WeoUxXuWVwjYKyHoPSMi', 'john@amdox.com', 'USER', 'John Doe', CURRENT_TIMESTAMP());
INSERT INTO user_entity (id, username, password, email, role, full_name, created_at) VALUES (3, 'emma', '$2a$10$ZsmpxUN3qGjWI2oDEhvrHOnBaF9kM4QK1WeoUxXuWVwjYKyHoPSMi', 'emma@amdox.com', 'USER', 'Emma Watson', CURRENT_TIMESTAMP());
INSERT INTO user_entity (id, username, password, email, role, full_name, created_at) VALUES (4, 'liam', '$2a$10$ZsmpxUN3qGjWI2oDEhvrHOnBaF9kM4QK1WeoUxXuWVwjYKyHoPSMi', 'liam@amdox.com', 'USER', 'Liam Brown', CURRENT_TIMESTAMP());
ALTER SEQUENCE USER_ENTITY_SEQ RESTART WITH 5;
